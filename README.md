...
unidpp-edge-services/
 ...
 roles.ts operator-model §2.2 → EN 18239 mapping catalog
...
- operator-model §2.2 (role catalog), §2.3 (permission matrices),
 §3 (federation charter), §6 (Cloudflare deployment map).
- the UniDPP design framework §4 (semantic layer), §5 (trust layer), §7 (resolver spec).
